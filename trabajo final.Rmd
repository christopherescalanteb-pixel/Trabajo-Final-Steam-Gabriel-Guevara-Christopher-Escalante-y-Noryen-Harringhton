...
steam_data <- steam_data %>%
  mutate(
    ...
    # Clasificación Indie vs AAA (ampliable)
...
2024). Sin embargo, esta abundancia de oferta ha generado un problema
crítico: **la parálisis por decisión y la competencia por la atención
del usuario**.\
...
steam_data %>%
  ...
  labs(x = "Tipo de juego", y = "Ratio de reseñas positivas",
       title = "Pregunta 1: ¿Los Indie superan a los AAA en valoración?") +
  theme_minimal() +
